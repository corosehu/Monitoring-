...
=== package.json content ===
{
  "name": "ig-monitor",
  "version": "1.0.0",
  "description": "A Discord bot that monitors Instagram accounts for ban and unban status changes",
  "main": "index.js",
  "scripts": {
    "start": "node index.js",
...
try {
    ...
    try {
        require('child_process').execSync('npm install discord.js', { stdio: 'inherit' });
    } catch (err) {
        console.error('Failed to install discord.js. Please install it manually: npm install discord.js');
        process.exit(1);
    }
}
...
const allowedUserIds = [...INITIAL_ALLOWED_USER_IDS];
const banWatchList = [];
